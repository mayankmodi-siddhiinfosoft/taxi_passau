...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    subscriptionModel = json['subscription_model'].toString();
    taxiVehicleCatId = json['taxi_vehicle_category_id'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['taxi_vehicle_category_id'] = taxiVehicleCatId;
    return data;
  }
}
