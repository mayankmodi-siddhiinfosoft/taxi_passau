...
import 'package:taxipassau_driver/controller/parcel_service_controller.dart';
...
import 'package:taxipassau_driver/page/search_location_screen.dart';
            ...
            body: Column(
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      if (double.parse(controller.totalEarn.value.toString()) < double.parse(Constant.minimumWalletBalance!) && controller.iswalletLoading.value == false)
                        Container(
