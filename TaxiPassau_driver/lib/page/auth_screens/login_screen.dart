...
import 'package:taxipassau_driver/controller/login_conroller.dart';
import 'package:taxipassau_driver/model/user_model.dart';
import 'package:taxipassau_driver/page/auth_screens/forgot_password.dart';
import 'package:taxipassau_driver/page/auth_screens/mobile_number_screen.dart';
...
import 'package:taxipassau_driver/widget/permission_dialog.dart';
                                            ...
                                            if (value != null) {
                                              if (value.success == "success") {
                                                ...
                                                if (Constant.adminCommission?.statut == "no" && Constant.subscriptionModel == false) {
                                                  ...
                                                  if (userData.subscriptionPlan?.id != null) {
                                                    if (userData.subscriptionExpiryDate == null) {
                                                      if (userData.subscriptionPlan?.expiryDay == '-1') {
                                                        isPlanExpire = false;
                                                      } else {
                                                        isPlanExpire = true;
                                                      }
                                                    } else {
                                                      DateTime expiryDate = DateTime.parse(userData.subscriptionExpiryDate!);
                                                      isPlanExpire = expiryDate.isBefore(DateTime.now());
                                                    }
                                                  } else {
                                                    isPlanExpire = true;
                                                  }
                                                  if (userData.subscriptionPlanId == null || isPlanExpire == true) {
                                                    Get.to(
