...
import 'package:taxipassau_driver/controller/ride_details_controller.dart';
import 'package:taxipassau_driver/model/driver_location_update.dart';
import 'package:taxipassau_driver/model/ride_model.dart';
import 'package:taxipassau_driver/page/chats_screen/conversation_screen.dart';
  ...
  getArgumentData() async {
    if (argumentData != null) {
      ...
      if (rideData!.statut == 'confirmed') {
        destinationLatLong = GeoPoint(latitude: double.parse(rideData!.latitudeDepart.toString()), longitude: double.parse(rideData!.longitudeDepart.toString()));
      } else {
