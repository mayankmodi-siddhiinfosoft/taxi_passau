...
import 'package:taxipassau_driver/controller/document_status_contoller.dart';
              ...
              : Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Securely upload your driving license, vehicle registration, and insurance documents.".tr,
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Expanded(
                                          child: Text(
                                            controller.documentList[index].documentName.toString().tr,
                                        ...
                                        Text(
                                          controller.documentList[index].documentStatus.toString().tr,
                                          style: TextStyle(
      ...
      content: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ButtonThem.buildButton(context, title: "Close".tr, btnHeight: 40, btnWidthRatio: 0.6, btnColor: AppThemeData.primary200, txtColor: Colors.white, onPress: () => Get.back()),
          ],
        ),
      ),
    );
