                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: ButtonThem.buildButton(context,
                              title: "Sent Request".tr, btnColor: AppThemeData.primary200, txtColor: themeChange.getThem() ? AppThemeData.grey900Dark : AppThemeData.grey900,
                              // onPress: () {
                              //   var bodyParams = {
                              ...
                              // },
                              onPress: () {
                            String price = controller.ridepriceText.value.text.trim();

                            // Remove comma format & fix decimal format if needed
                            price = price.replaceAll(",", "");

                            if (price.isEmpty || double.tryParse(price) == null) {
                              ShowToastDialog.showToast("Please enter valid price!");
                              return;
                            }
