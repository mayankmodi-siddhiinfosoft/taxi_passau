                    ...
                    Padding(
                        ...
                        child: ButtonThem.buildButton(context, title: "Pay ${Constant().amountShow(amount: controller.getTotalAmount().toString())}".tr, onPress: () async {
                          ...
                          if (controller.selectedRadioTile.value == "Wallet") {
                            ...
                            stripeMakePayment(amount: controller.getTotalAmount().toStringAsFixed(2));
...
//Orangepay payment
  ...
  Future webpayment({required String orderIdData, required BuildContext context, required String currency, required String amountData, required PaymentController controller}) async {
    orderId = orderIdData;
    amount = amountData;
